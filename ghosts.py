...
class Pinky(Ghost):
    ...
    def chase(self):
        self.goal = self.pacman.position + self.pacman.directions[self.pacman.direction]*(TILEWIDTH<<2)
...
class Inky(Ghost):
    ...
    def chase(self):
        vec1 = self.pacman.position + self.pacman.directions[self.pacman.direction]*(TILEWIDTH<<1)
